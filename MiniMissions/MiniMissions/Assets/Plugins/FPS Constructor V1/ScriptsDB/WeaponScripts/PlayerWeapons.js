...
public var weapons : GameObject[]; //Array of equipped weapons (accessible by number keys)
public var selectedWeapon : int = 0; //index of currently selected weapon in array
...
public function SelectWeapon(index : int){
