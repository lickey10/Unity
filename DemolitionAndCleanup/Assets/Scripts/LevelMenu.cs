...
public class LevelMenu : MonoBehaviour {
	...
	void OnGUI()
	{
		...
		//GUI.Box(new Rect( 3, 3, 450, 40 ), "Demolition Crew" ,customGuiStyle);
		
		//customGuiStyle.normal.textColor = Color.green;
		//GUI.Box(new Rect( 0, 0, 450, 40 ), "Demolition Crew", customGuiStyle);

		//levels
		//drop shadow
		customGuiStyle.normal.textColor = Color.black;
		GUI.Box(new Rect( 3, 53, 450, 40 ), "Levels" ,customGuiStyle);

		customGuiStyle.normal.textColor = Color.yellow;
		GUI.Box(new Rect( 0, 50, 450, 40 ), "Levels" ,customGuiStyle);
