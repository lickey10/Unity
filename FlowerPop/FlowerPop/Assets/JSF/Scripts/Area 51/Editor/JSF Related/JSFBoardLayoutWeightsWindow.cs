...
public class JSFBoardLayoutWeightsWindow : EditorWindow
{
	static JSFBoardLayout bl;
	static int pos = 0;
    ...
    {
		pos = position;
		EditorWindow bsc = EditorWindow.GetWindow (typeof (JSFBoardLayoutWeightsWindow),false, "Set Weights");
