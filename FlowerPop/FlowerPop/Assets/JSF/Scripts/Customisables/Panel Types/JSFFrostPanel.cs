...
public class JSFFrostPanel : JSFPanelDefinition {
	...
	public override void playAudioVisuals(JSFBoardPanel bp){
		bp.master.gm.audioScript.icePanelHitFx.play();
		bp.master.gm.animScript.doAnim(JSFanimType.ICEHIT, bp.master.arrayRef[0], bp.master.arrayRef[1] );
	}
}
