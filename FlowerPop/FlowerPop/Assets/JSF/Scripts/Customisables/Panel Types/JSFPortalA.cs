...
public class JSFPortalA : JSFPanelDefinition {

	public List<JSFBoard> boardA = new List<JSFBoard>(); // the board A - entry path reference
	public List<JSFBoard> boardB = new List<JSFBoard>(); // the board B - exit path reference
