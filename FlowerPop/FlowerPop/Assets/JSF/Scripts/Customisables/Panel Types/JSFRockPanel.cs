...
public class JSFRockPanel : JSFPanelDefinition {
	...
	public override void playAudioVisuals(JSFBoardPanel bp){
		bp.master.gm.audioScript.rockPanelHitFx.play();
		bp.master.gm.animScript.doAnim(JSFanimType.ROCKHIT, bp.master.arrayRef[0], bp.master.arrayRef[1] );
	}
}
