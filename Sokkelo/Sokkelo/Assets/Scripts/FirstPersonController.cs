...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
			...
			#if !MOBILE_INPUT
			//hide joystick
			GameObject.Find ("SensitiveJoystick").SetActive(false);
			#endif
        }
        ...
        private void FixedUpdate()
        {
			...
			euler.z = Mathf.Lerp(euler.z, -accelerator.x, 0.2f);
			
			// Since we set absolute lean position, do some extra smoothing on it
			//euler.x = Mathf.Lerp(euler.x, accelerator.y * maxTilt, 0.2);
			euler.x = Mathf.Lerp(euler.x, accelerator.y, 0.2f);
        ...
        private void GetInput(out float speed)
        {
			...
			// get movement values from joystick
