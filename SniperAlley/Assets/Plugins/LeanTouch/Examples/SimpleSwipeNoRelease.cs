...
public class SimpleSwipeNoRelease : MonoBehaviour
{
	...
	private LeanTouch.LeanFinger swipingFinger;
	...
	public void OnFingerSet(LeanTouch.LeanFinger finger)
	{
		...
		if (finger == swipingFinger)
		{
			...
			var swipeThreshold = LeanTouch.LeanTouch.Instance.SwipeThreshold;

			// The amount of seconds we consider valid for a swipe
			var tapThreshold = LeanTouch.LeanTouch.Instance.TapThreshold;
