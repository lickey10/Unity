	...
	protected virtual void Update()
	{
		...
		if (SelectedGameObject != null)
		{
			...
			if (Camera.main != null)
			{
				...
				{
					Translate(SelectedGameObject.transform, LeanTouch.LeanTouch.DragDelta);
				}

				if (AllowRotate == true)
				{
					RotateRelative(SelectedGameObject.transform, LeanTouch.LeanTouch.TwistDegrees, LeanTouch.LeanTouch.CenterOfFingers);
				}

				if (AllowScale == true)
				{
					ScaleRelative(SelectedGameObject.transform, LeanTouch.LeanTouch.PinchScale, LeanTouch.LeanTouch.CenterOfFingers);
				}
			}
		}
	}
