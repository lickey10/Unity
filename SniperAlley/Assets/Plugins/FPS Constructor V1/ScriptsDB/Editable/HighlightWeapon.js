...
function OnGUI () {
	...
	if(selected && !DBStoreController.inStore){
		...
		var myButtonStyle : GUIStyle = new GUIStyle(GUI.skin.button);
		myButtonStyle.fontSize = 30;
	    // Load and set Font
		//var myFont : Font = (Font)Resources.Load("Fonts/comic", typeof(Font));
		...
		GUI.Box(Rect(pos.x-77.5, Screen.height-pos.y-(Screen.height/4)-52.5,500, 200), info.WeaponInfo.gunName + "\n \n" + info.WeaponInfo.gunDescription + "\n" + s,myButtonStyle);
	}
}