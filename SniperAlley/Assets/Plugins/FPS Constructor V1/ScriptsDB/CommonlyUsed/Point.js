...
function Start() {
	...
	BroadcastMessage("AddToScore", Point, SendMessageOptions.DontRequireReceiver);
}
...
function OnGUI() {
	...
	GUI.Label (Rect (screenPos2.x+8 , targY-2, 160, 140), "+" + Point.ToString());
	GUI.skin = PointSkin;
	GUI.Label (Rect (screenPos2.x+10 , targY, 240, 240), "+" + Point.ToString());
}
