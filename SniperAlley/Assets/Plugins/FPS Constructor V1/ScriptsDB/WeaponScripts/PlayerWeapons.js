...
function SetSensitivity () {
	//transform.parent.GetComponent(MouseLookMultiFinger).sensitivityStandardX = sensitivity;
	//if(inverted)
	//	sensitivity *= -1;
	//this.GetComponent(MouseLookMultiFinger).sensitivityStandardY = sensitivity;
...
function Update(){
	...
	if(interactDistance >0){
		...
		//Interact
		if((InputDB.GetButtonDown ("Interact") || Input.GetMouseButtonDown(0)) && lastHit!=null){
