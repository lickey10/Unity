...
public class GoogleMobileAdsDemoScript : MonoBehaviour
{
	...
	private BannerView bannerView_bottom;
...
//        }
    ...
    private void RequestBanner()
    {
			...
			string adUnitId_bottom = "unused";
        #elif UNITY_ANDROID
		string adUnitId = "ca-app-pub-2335297199953104/2164780677";
		string adUnitId_bottom = "ca-app-pub-2335297199953104/2164780677";
        #elif UNITY_IPHONE
			string adUnitId = "";
			string adUnitId_bottom = "";
        #else 
			//windows?
			string adUnitId = "";
			string adUnitId_bottom = "";
		...
		bannerView_bottom = new BannerView(adUnitId_bottom, AdSize.SmartBanner, AdPosition.Bottom);
		// Register for ad events.
		bannerView_bottom.AdLoaded += HandleAdLoaded;
		bannerView_bottom.AdFailedToLoad += HandleAdFailedToLoad;
		bannerView_bottom.AdOpened += HandleAdOpened;
		bannerView_bottom.AdClosing += HandleAdClosing;
		bannerView_bottom.AdClosed += HandleAdClosed;
		bannerView_bottom.AdLeftApplication += HandleAdLeftApplication;
		// Load a banner ad.
		bannerView_bottom.LoadAd(createAdRequest());
    }
