...
public class BackgroundMusic_colorSpin : Singleton_colorSpin<BackgroundMusic_colorSpin> 
{
	...
	void OnEnable()
	{
        ...
        AudioManager_colorSpin.OnMusicStatusChangedEvent += OnMusicStatusChangedEvent;
	}
	...
	void StartBGMusic()
	{
		...
		if (AudioManager_colorSpin.Instance.isMusicEnabled && !CurrentAudioSource.isPlaying ) {
