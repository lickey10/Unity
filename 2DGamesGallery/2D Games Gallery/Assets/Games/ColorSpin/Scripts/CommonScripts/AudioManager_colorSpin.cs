...
public class AudioManager_colorSpin : Singleton_colorSpin<AudioManager_colorSpin>
{
	...
	{
		if (AudioManager_colorSpin.Instance.isSoundEnabled && clickSound != null) {
	...
	{
		if (AudioManager_colorSpin.Instance.isSoundEnabled) {
