...
namespace AppAdvisory.SpringPong
{
	...
	public class GameManager : MonoBehaviour 
	{
		...
		Text textInGame
		{
			get
			{
				if(m_textInGame == null)
					m_textInGame = FindObjectOfType<AppAdvisory.UI.UIController2>().scoreIngame;
		...
		void Awake()
		{
			...
			FindObjectOfType<AppAdvisory.UI.UIController2>().textLast.text = "LAST\n" + Utils.GetLast();
			FindObjectOfType<AppAdvisory.UI.UIController2>().textBest.text = "BEST\n" + Utils.GetBest();
		...
		void DOGameOver()
		{
			...
			FindObjectOfType<AppAdvisory.UI.UIController2>().DOTakeScreenshotWithVerySimpleShare();
...
{
	FindObjectOfType<AppAdvisory.UI.UIController2>().HideVerySimpleShare();
}
