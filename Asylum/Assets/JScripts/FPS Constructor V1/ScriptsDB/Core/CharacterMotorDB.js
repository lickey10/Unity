...
private var controller : CharacterController;
    ...
    var CnControlsScript : CnControls.SensitiveJoystick;

function Start(){  // for performance reasons, it's always good to get your components in the Awake or Start function
 
    CnControlsScript = joystick.GetComponent(CnControls.SensitiveJoystick);
}
...
function Update () {
	...
	inputMoveDirection.x = CnControlsScript.CnInputManager.GetAxis("Horizontal");
	inputMoveDirection.y = CnControlsScript.CnInputManager.GetAxis("Vertical");
