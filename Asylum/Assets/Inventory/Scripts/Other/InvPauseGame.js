...
function Awake () 
{
	...
	if (disableMouseLookComponent == true)
	{
		...
		{
			if (ThePlayer.GetComponent("MouseLookDBJS") != null && TheCamera.GetComponent("MouseLookDBJS") != null)
			{
				lookAround01 = ThePlayer.GetComponent("MouseLookDBJS");
				lookAround02 = TheCamera.GetComponent("MouseLookDBJS");
			}
			else
			{
