...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        public int CameraHeightOffset = 0;
        public int CameraFrontBackOffset = 0;
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(transform.position,new Vector3(m_Target.position.x + CameraFrontBackOffset, m_Target.position.y +CameraHeightOffset, m_Target.position.z), deltaTime*m_MoveSpeed);
