...
class InventoryEditor extends EditorWindow {
	...
	function InventorySetUp ()
	{
		...
		if (includeCSheet)
		{
			invObject.AddComponent(CharacterInventory);
			
			if (selectedObject.GetComponent(CharacterInventory) != null)
			{
		...
		var csheet = invObject.GetComponent(CharacterInventory);
	...
	function InventoryDelete ()
	{
		...
		if (selectedObject.GetComponent(CharacterInventory) != null)
		{
			DestroyImmediate(selectedObject.gameObject.GetComponent(CharacterInventory));
		}
