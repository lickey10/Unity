...
AddAllUnits();
	...
	if(DisableRespawn){}
		...
		//DEATH
		if(dead){
			charactermodel.GetComponent<Animation>().wrapMode = WrapMode.Once;
			...
			if(deathsound){
				...
				GetComponent<AudioSource>().clip=deathsounds[deathsoundrandom];
		...
		if(death){
				if(deadanim){
		charactermodel.GetComponent<Animation>()[death.name].speed = charactermodel.GetComponent<Animation>()[death.name].length / deathanimationspeed;
			charactermodel.GetComponent<Animation>().CrossFade( death.name);	
				deadanim=false;
...
if(stand){
		...
		charactermodel.GetComponent<Animation>()[stand.name].speed = charactermodel.GetComponent<Animation>()[stand.name].length / idleanimationspeed;
			
			charactermodel.GetComponent<Animation>().CrossFade( stand.name, 0.3f);	
			}
			}
	...
	transform.position += transform.forward * runspeed * Time.deltaTime;
		...
		charactermodel.GetComponent<Animation>()[run.name].speed = charactermodel.GetComponent<Animation>()[run.name].length / runanimationspeed;
			
							charactermodel.GetComponent<Animation>().CrossFade( run.name, 0.1f);	
			}
				}		
			}
	...
	transform.position += transform.forward * walkspeed * Time.deltaTime;
		...
		charactermodel.GetComponent<Animation>()[walk.name].speed = charactermodel.GetComponent<Animation>()[walk.name].length / walkanimationspeed;
			charactermodel.GetComponent<Animation>().CrossFade( walk.name, 0.15f);	
			}
				}		
			}		
	...
	if(charge){
		...
		charactermodel.GetComponent<Animation>()[run.name].speed = charactermodel.GetComponent<Animation>()[run.name].length / 0.9f;
			charactermodel.GetComponent<Animation>().CrossFade( run.name);	
			}
				}
		...
		charactermodel.GetComponent<Animation>()[attackstand.name].speed = charactermodel.GetComponent<Animation>()[attackstand.name].length / 1f;
			charactermodel.GetComponent<Animation>().CrossFade( attackstand.name);	
						}
...
return Vector3.Distance(p2.position, transform.position).CompareTo(Vector3.Distance(p1.position, transform.position));	
		...
		charactermodel.GetComponent<Animation>()[Attackanimations[attackran].name].speed = charactermodel.GetComponent<Animation>()[Attackanimations[attackran].name].length / (attackspeed*0.75f);
			charactermodel.GetComponent<Animation>().CrossFade( Attackanimations[attackran].name);	
			}
			}
					}
		...
		charactermodel.GetComponent<Animation>()[attackstand.name].speed = charactermodel.GetComponent<Animation>()[attackstand.name].length / 1f;
			...
			if(Dialogaskhelp){
				...
				GetComponent<AudioSource>().clip=askhelpsounds[askhelpsoundrandom];
				GetComponent<AudioSource>().Play();
				}
				Dialogaskhelp=false;
			}
			...
			if(Dialogrespond){
				...
				GetComponent<AudioSource>().clip=respondsounds[respondsoundrandom];
				GetComponent<AudioSource>().Play();
					}
					airespond=false;
				Dialogrespond=false;
		...
		if(enablesounds){
				...
				GetComponent<AudioSource>().clip=spotsounds[spotsoundrandom];
				GetComponent<AudioSource>().Play();
							}
				}
			...
			if(idle){
				...
				GetComponent<AudioSource>().clip=idlesounds[idlesoundrandom];
				GetComponent<AudioSource>().Play();
							}
					idlesoundtimer=0;
				}
		...
		if(awarnesspercent<100){
			if(hunt){
				...
				GetComponent<AudioSource>().clip=alertsounds[alertsoundrandom];
				GetComponent<AudioSource>().Play();
									}
					alertsound=false;
					//alerttimer=0;
				...
				GetComponent<AudioSource>().clip=huntsounds[huntsoundrandom];
				GetComponent<AudioSource>().Play();
								}
					huntsoundtimer=0;
				}
			...
			if(retreat){
				...
				GetComponent<AudioSource>().clip=retreatsounds[retreatsoundrandom];
				GetComponent<AudioSource>().Play();
							}
							retreatsound=false;	
							}	
