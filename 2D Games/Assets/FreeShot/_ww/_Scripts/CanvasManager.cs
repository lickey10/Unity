...
public class CanvasManager : Singleton<CanvasManager> 
{
	...
	void SetButtons()
	{
		...
		buttonUnlock.onClick.AddListener (() => {
			...
			GameManager3.Instance.RefreshColors();
		});
	...
	private void ShowRewardedVideoGameOver(){
        ...
        GameManager3.Instance.success = false;
        GameManager3.Instance.isGameOver = false;
	...
	void SetButtonActive(Button b,bool isActive)
	{
		if (isActive) 
		{
			if(GameManager3.Instance != null && GameManager3.Instance.currentAAColor != null)
			{
				b.GetComponent<Image> ().color = GameManager3.Instance.currentAAColor.colorBright;
			}
			b.interactable = true;
		} 
		else
	...
	public void AnimationCameraGameOver()
	{
        ...
        GameManager3.Instance.canShoot = false;
	...
	private void PlayLevel(int level, bool fromSuccess)
	{
        ...
        GameManager3.Instance.CreateGame (level, fromSuccess);
