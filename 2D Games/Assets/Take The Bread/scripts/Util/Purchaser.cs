...
public class Purchaser : MonoBehaviour, IStoreListener
{
		...
		public void InitializePurchasing() 
		{
				...
				builder.Configure<IGooglePlayConfiguration>().SetPublicKey(GameManager2.publishKey);
				builder.AddProduct("pack0", ProductType.NonConsumable, new IDs
						{
								{GameManager2.CONSUMABLE0, GooglePlay.Name},
								{GameManager2.CONSUMABLE0, AppleAppStore.Name},
						});

				builder.AddProduct("pack1", ProductType.Consumable, new IDs
						{
								{GameManager2.CONSUMABLE1, GooglePlay.Name},
								{GameManager2.CONSUMABLE1, AppleAppStore.Name},
						});
				builder.AddProduct("pack2", ProductType.Consumable, new IDs
						{
								{GameManager2.CONSUMABLE2, GooglePlay.Name},
								{GameManager2.CONSUMABLE2, AppleAppStore.Name},
						});
				builder.AddProduct("pack3", ProductType.Consumable, new IDs
						{
								{GameManager2.CONSUMABLE3, GooglePlay.Name},
								{GameManager2.CONSUMABLE3, AppleAppStore.Name},
						});
		...
		public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
		{
				...
				for (int n = 0; n < items.Length; n++) {
						if (String.Equals (args.purchasedProduct.definition.id, items[n], StringComparison.Ordinal)) {
								...
								GameManager2.getInstance ().purchansedCallback (args.purchasedProduct.definition.id);
