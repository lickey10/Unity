...
public class PanelMain : MonoBehaviour {
		...
		public void OnClick(GameObject g){
				...
				case "btnGC":
						GameManager2.getInstance().playSfx("click");
						GameManager2.getInstance().ShowLeaderboard();
						break;
				}
		}
		...
		public void OnToggle(Toggle toggle){
				...
				case "ToggleMusic":
						...
						if(toggle.isOn){
								GameManager2.getInstance().stopBGMusic();
						}else{
								GameManager2.getInstance().playMusic("bgmusic");
						}
				...
				case "ToggleSfx":
						...
						if(toggle.isOn){
								GameManager2.getInstance().stopAllSFX();
						}
