...
namespace SQLiteClass
{
    ...
    /// </summary>
    public class SQLiteBeer : MonoBehaviour
    {
        public static SQLiteBeer Instance = null;
        public bool DebugMode = false;
		public UILabel UiLabel;
		private int nextQuestionID = 507;

        /// <summary>
        /// Table name and DB actual file location
        /// </summary>
        private const string SQL_DB_NAME = "beerme";
...
//        private const string COL_GOLD = "gold";
        ...
        void Start()
        {
			...
			UiLabel.text = GetNextQuestion (nextQuestionID);
        }
...
//        }
		...
		public string GetNextQuestion(int questionID)
		{
			...
			mCommand.CommandText = "SELECT question FROM Questions where questionID =" + questionID;
			mReader = mCommand.ExecuteReader();
			while (mReader.Read())
			{
				// reuse same stringbuilder
...
//				sb.Append(mReader.GetInt32(5)).Append(" ");
		...
		public void GetAnswers(int questionID)
		{
			...
			mCommand.CommandText = "SELECT answer,nextQuestionID,outcomesID FROM Answers where questionID =" + questionID;
			mReader = mCommand.ExecuteReader();
			while (mReader.Read())
			{
		...
		public System.Collections.ArrayList GetResults(string query)
		{
			//System.Text.StringBuilder sb = new System.Text.StringBuilder();
			Object[] results;
			System.Collections.ArrayList arResults = new System.Collections.ArrayList();
...
//					Debug.Log(sb.ToString());
				...
				results = new Object[mReader.FieldCount];

				mReader.GetValues(results);

				arResults.Add(results);
			}
			mReader.Close();
			mConnection.Close();
